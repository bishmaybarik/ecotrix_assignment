/*******************************************************************
File: Cleaning Do File
Purpose: Data Cleaning Codes | .txt to .dta
Author(s): Aftab, Bishmay, Manya
******************************************************************/
...
import delimited using "$raw/TXT/hces22_lvl_01.txt",clear
...
save "$output/dta/level_01.dta", replace

************************** LEVEL 02 *******************************

import delimited using "$raw/TXT/hces22_lvl_02.txt",clear
...
merge m:1 common_id using "$output/dta/level_01", force nogen keep(3) keepusing(hhid)
drop v1 common_id
destring level-hhid,force replace
order hhid
// Save

save "$output/dta/level_02.dta", replace

************************* LEVEL 03 *******************************

import delimited using "$raw/TXT/hces22_lvl_03.txt",clear
...
save "$output/dta/level_03", replace

************************* LEVEL 04 *******************************

import delimited using "$raw/TXT/hces22_lvl_04.txt",clear
...
save "$output/dta/level_04", replace

************************* LEVEL 05 *******************************

import delimited using "$raw/TXT/hces22_lvl_05.txt",clear
...
save "$output/dta/level_05", replace

************************* LEVEL 06 *******************************

import delimited using "$raw/TXT/hces22_lvl_06.txt",clear
...
save "$output/dta/level_06", replace

************************* LEVEL 07 *******************************

import delimited using "$raw/TXT/hces22_lvl_07.txt",clear
...
save "$output/dta/level_07", replace

************************* LEVEL 08 *******************************

import delimited using "$raw/TXT/hces22_lvl_08.txt",clear
...
save "$output/dta/level_08", replace


************************* LEVEL 09 *******************************

import delimited using "$raw/TXT/hces22_lvl_09.txt",clear
...
save "$output/dta/level_09", replace

************************* LEVEL 10 *******************************

import delimited using "$raw/TXT/hces22_lvl_10.txt",clear
...
save "$output/dta/level_10", replace

************************* LEVEL 11 *******************************

import delimited using "$raw/TXT/hces22_lvl_11.txt",clear
...
save "$output/dta/level_11", replace


************************* LEVEL 12 *******************************

import delimited using "$raw/TXT/hces22_lvl_12.txt",clear
...
save "$output/dta/level_12", replace

************************* LEVEL 13 *******************************

import delimited using "$raw/TXT/hces22_lvl_13.txt",clear
...
save "$output/dta/level_13", replace



************************* LEVEL 14 *******************************

import delimited using "$raw/TXT/hces22_lvl_14.txt",clear
...
save "$output/dta/level_14", replace


************************* LEVEL 15 *******************************

import delimited using "$raw/TXT/hces22_lvl_15.txt",clear
...
save "$output/dta/level_15", replace
...
foreach i in `vals'{
	use "$output/dta/level_`i'", clear
	export delimited using "$output/csv/level_`i'.csv", replace
}
