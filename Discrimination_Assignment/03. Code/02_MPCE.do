...
merge 1:1 hhid using "$output/dta/level_01", force nogen keepusing(sector)

save "$output/mpce/mpce.dta",replace

/*-------------------------------------
MPCE: BY SECTOR
----------------------------------------*/
use "$output/mpce/mpce.dta",clear
...
use "$output/mpce/mpce.dta", clear
merge 1:m hhid using "$output/dta/level_03", force nogen // pull hh_size
...
save "$output/mpce/fractile_mpce.dta", replace
